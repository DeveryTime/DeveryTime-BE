package com.dms.deverytime.global.security.jwt;

import com.dms.deverytime.global.exception.DeveryTimeException;
import com.dms.deverytime.global.exception.ErrorCode;
import com.dms.deverytime.global.security.auth.CustomUserDetailsService;
...
public class JwtProvider {
    ...
    public Claims getClaims(String token){
        try{
            ...
            throw new DeveryTimeException(ErrorCode.TOKEN_EXPIRED);
        } catch (JwtException | IllegalArgumentException e) {
            throw new DeveryTimeException(ErrorCode.TOKEN_INVALID);
        }
    }
